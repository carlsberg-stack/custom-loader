package com.carlsberg_stack.customp_progress_loader;
...
public class CSProgress {
    ...
    public CSProgress(Context context) {
        mContext = context;
        mProgressDialog = new ProgressDialog(context);
        mDimAmount = 0;
        //noinspection deprecation
        mWindowColor = context.getResources().getColor(R.color.cs_progress_bar_default_color);
        mAnimateSpeed = 1;
        mCornerRadius = 10;
        mIsAutoDismiss = true;
     ...
     */
    public static CSProgress create(Context context) {
        return new CSProgress(context);
    }

    /**
     * Specify the HUD style (not needed if you use a custom view)
     * @param style One of the CSProgress.Style values
     * @return Current HUD
     */
    public CSProgress setStyle(Style style) {
        View view = null;
        switch (style) {
     ...
     * @return Current HUD
     */
    public CSProgress setDimAmount(float dimAmount) {
     ...
     * @return Current HUD
     */
    public CSProgress setWindowColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public CSProgress setCornerRadius(float radius) {
     ...
     * @return Current HUD
     */
    public CSProgress setAnimationSpeed(int scale) {
        mAnimateSpeed = scale;
        return this;
    }
     ...
     * @return Current HUD
     */
    public CSProgress setLabel(String label) {
        mLabel = label;
        return this;
    }
     ...
     * @return Current HUD
     */
    public CSProgress setDetailsLabel(String detailsLabel) {
     ...
     * @return Current HUD
     */
    public CSProgress setMaxProgress(int maxProgress) {
     ...
     * @return Current HUD
     */
    public CSProgress setCustomView(View view) {
        if (view != null) {
            mProgressDialog.setView(view);
        } else {
     ...
     * @return Current HUD
     */
    public CSProgress setCancellable(boolean isCancellable) {
     ...
     * @return Current HUD
     */
    public CSProgress setAutoDismiss(boolean isAutoDismiss) {
        mIsAutoDismiss = isAutoDismiss;
        return this;
    }

    public CSProgress show() {
        if (!isShowing()) {
    ...
    private class ProgressDialog extends Dialog {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.cs_progress);
